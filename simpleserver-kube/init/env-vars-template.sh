...
export TF_VAR_ADMIN_PROJ_ID=$TF_VAR_PREFIX-parent-$GCP_ADMIN_VERSION
export TF_VAR_CREDS=~/.config/gcloud/${USER}-terraform-${TF_VAR_ADMIN_PROJ_ID}.json
export TF_VAR_ADMIN_PROJ_NAME=$TF_VAR_PREFIX-terraform-parent
export TF_VAR_TERRA_BACKEND_BUCKET_NAME=$TF_VAR_PREFIX-terraform-$GCP_ADMIN_VERSION
export TF_VAR_INFRA_PROJ_ID=$GCP_INFRA_VERSION
export TF_VAR_INFRA_PROJ_NAME=$TF_VAR_PREFIX
export TF_VAR_FOLDER_ID=TODO
export TF_VAR_ORG_ID=TODO
export TF_VAR_BILLING_ACCOUNT_ID=TODO
